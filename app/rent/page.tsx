...
export const metadata = listingMetadata("rent");

export default async function RentPage(props: PageProps<"/rent">) {
  ...
  const [properties, propertyTypes] = await Promise.all([
    getPropertiesByListingType("rent"),
